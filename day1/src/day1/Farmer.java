...
public class Farmer {
    public static void main(String[] args) {
        ...
        // Tomatoes
        double tomato30Yield = 0.3 * acresPerSegment * 10;
        double tomato70Yield = 0.7 * acresPerSegment * 12;
        double totalTomatoKg = (tomato30Yield + tomato70Yield) * 1000;
        double tomatoSales = totalTomatoKg * 7;

        // Potatoes
        double potatoTonnes = acresPerSegment * 10;
        double potatoSales = potatoTonnes * 1000 * 20;

        // Cabbage
        double cabbageTonnes = acresPerSegment * 14;
        double cabbageSales = cabbageTonnes * 1000 * 24;

        // Sunflower
        double sunflowerTonnes = acresPerSegment * 0.7;
        double sunflowerSales = sunflowerTonnes * 1000 * 200;

        // Sugarcane
        double sugarcaneTonnes = acresPerSegment * 45;
        double sugarcaneSales = sugarcaneTonnes * 4000;
        ...
        System.out.println("a. Total Sales from 80 acres: ₹" + totalSales);
        System.out.println("b. Sales from Chemical-Free Farming at end of 11 months: ₹" + chemicalFreeSales);
    }
}